...
AuthLayout
  .text-center.mb-6
    ...
    p.text-sm.text-muted-foreground.mt-1 Preencha os dados abaixo para começar
    ...
    .space-y-1
      .flex.items-center.gap-2
        Checkbox#terms(
          ...
          @update:checked="termsAccepted = $event; termsError = ''"
        )
        Label.text-sm.cursor-pointer(for="terms")
          | Aceito os&nbsp;
