      ...
      .container.mx-auto
        ...
        .grid.gap-6(class="grid-cols-1 md:grid-cols-2 lg:grid-cols-3")
          .rounded-xl.border.border-border.bg-card.p-6.transition-shadow(
            ...
            p.text-sm.text-muted-foreground {{ feature.description }}
      ...
      .container.mx-auto
        ...
        .grid.gap-8(class="grid-cols-1 md:grid-cols-2 lg:grid-cols-4")
          .text-center(v-for="step in steps" :key="step.number")
            ...
            p.text-sm.text-muted-foreground {{ step.description }}
      ...
      .container.mx-auto
        ...
        .grid.gap-6(class="grid-cols-1 md:grid-cols-3")
          .rounded-xl.border.border-border.bg-card.p-6(
            ...
            p.text-sm.mb-4.italic.text-muted-foreground &ldquo;{{ testimonial.text }}&rdquo;
            .flex.items-center.gap-2
              ...
              div
                ...
                p.text-xs.text-muted-foreground {{ testimonial.location }}
